...
void delEntregasPlanejadas(int idProcurado) {
...
void view_entregaPlanejada(){
    retirar_entregasPlanejadas();
    printf("Esses sao as entregas planejadas cadastrados: \n");
    for(int k = 0; k < tamanhoE; k++){
        printf("ID: %d - CLIENTE: %s\n", vetor_entregas_planejadas[k].id, vetor_entregas_planejadas[k].cliente.nome);
    }
}
...
void delEntregasRealizadas(int id_DelEntrega_realizada) {
...
void view_entregaRealizada(){
    retirar_entregasRealizadas();
    printf("Esses sao as entregas realizadas cadastrados: \n");
    for(int k = 0; k < tamanhoE2; k++){
        printf("ID: %d - CLIENTE: %s\n", vetor_entregas_realizadas[k].entrega_e1.id, vetor_entregas_realizadas[k].entrega_e1.cliente.nome);
    }
}
...
void realizar_entrega(int id_entrega_planejada) {
    ...
    if (arquivo_ == NULL){
        ...
        delEntregasPlanejadas(nova_entrega_realizada.entrega_e1.id);
    }
    fclose(arquivo_);
}
